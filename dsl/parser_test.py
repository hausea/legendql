...
class ParserTest(unittest.TestCase):
    ...
    def test_select(self):
        ...
        p = Parser.parse(select, [lq.schema], ParseType.select)
    ...
    def test_rename(self):
        ...
        p = Parser.parse(rename, [lq.schema], ParseType.rename)
    ...
    def test_join(self):
        ...
        p = Parser.parse(join, [lq.schema, jq.schema], ParseType.join)
    ...
    def test_window(self):
        ...
        p = Parser.parse(window, [lq.schema], ParseType.over)
